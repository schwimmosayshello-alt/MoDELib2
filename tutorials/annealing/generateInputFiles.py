...
setInputVariable('inputFiles/'+DDfile,'dtMax','1e35')
...
setInputVariable('inputFiles/'+microstructureFile1,'targetDensity_SI','1e14')
setInputVariable('inputFiles/'+microstructureFile1,'radiusDistributionMean_SI','5e-08')
setInputVariable('inputFiles/'+microstructureFile1,'radiusDistributionStd_SI','1e-09')
setInputVariable('inputFiles/'+microstructureFile1,'areVacancyLoops','1')
...
setInputVector('inputFiles/'+microstructureFile1,'allowedPlaneIDs',np.array([-1]),'# set of plane IDs containing the loops. Use -1 for random plane')
